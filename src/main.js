...
character = function(){
	...
	this.flash.alpha=0
	this.flash_blue=game.add.sprite(0,0,'flash_blue')
	this.flash_blue.alpha=0
...
character.prototype.reset_button_color = function() {
	this.button1.tint=this.rose;this.button2.tint=this.rose
}
	...
	if(this.flag_on_life){
		if(this.tween_move1_dont_exist==false){
			...
			this.flag_repulse && this.show_little_effect_left()
				...
				this.tween_repulse_to_right1 = game.add.tween(this.scale).to({x:2,y:.6},this.time_repulse,Phaser.Easing.Linear.None,true,0)
	...
	if(this.flag_on_life){
		if(this.tween_move1_dont_exist==false){
			...
			this.flag_repulse && this.show_little_effect_right()
				...
				this.audio_repulse()
				this.flag_anim_button2 && this.anim_button2()
				this.tween_exist && this.stop_move()	
				this.tween_repulse_to_left = game.add.tween(this).to({x:this.x-200,y:h2+25},this.time_repulse,Phaser.Easing.Linear.None,true,0)
				this.tween_repulse_to_left1 = game.add.tween(this.scale).to({x:2,y:.6},this.time_repulse,Phaser.Easing.Linear.None,true,0)
				this.tween_repulse_to_left.onComplete.add(this.flag_repulse_on,this)
			}
	}
}

character.prototype.anim_button1 = function() {
	this.flag_anim_button1=false
				this.tween_anim_button1 = game.add.tween(this.button1.scale).to({x:2,y:2},this.time_repulse*.4,Phaser.Easing.Linear.None,true,0)
this.tween_anim_button1.yoyo(this.time_repulse*.5,true)	
this.tween_anim_button1.onComplete.add(function(){this.flag_anim_button1=true},this)
}
character.prototype.anim_button2 = function() {
	this.flag_anim_button2=false
				this.tween_anim_button2 = game.add.tween(this.button2.scale).to({x:2,y:2},this.time_repulse*.4,Phaser.Easing.Linear.None,true,0)
this.tween_anim_button2.yoyo(this.time_repulse*.5,true)	
this.tween_anim_button2.onComplete.add(function(){this.flag_anim_button2=true},this)
...
character.prototype.show_little_effect_right = function() {
	if (this.flag_effect){
		this.flag_effect=false
		this.tween_effect3=game.add.tween(this.button2.effect).to({alpha:.01},this.time_repulse,Phaser.Easing.Bounce.Out,true,0)
...
character.prototype.show_little_effect_left = function() {
	if (this.flag_effect){
		this.flag_effect=false
		this.tween_effect4=game.add.tween(this.button1.effect).to({alpha:.01},this.time_repulse,Phaser.Easing.Bounce.Out,true,0)
...
character.prototype.anim_flash_blue = function() {
	this.tween_flash_blue = game.add.tween(this.flash_blue).to({alpha:1},100,Phaser.Easing.Bounce.Out,true,0,2)
	this.tween_flash_blue.yoyo(100,true)
this.button1.tint=0xffdc00	
this.button2.tint=this.button1.tint	
}
...
character.prototype.random_effect=function(){
	if(this.flag_on_life){
	console.log('random_effect')
	console.log('this.tween_move1_dont_exist',this.tween_move1_dont_exist)
...
character.prototype.move_to_center = function(next_function){
	...
	this.tween_move_to_center.onComplete.add(this.anim_flash_blue,this)
}
...
character.prototype.flag_repulse_on = function() {
	this.tween_move1_dont_exist && this.flag_on_life && this.reset_aspect()
	this.flag_repulse=true
}
...
character.prototype.update=function(){
	...
	if (this.tween_move1_dont_exist){
...
character.prototype.die = function() {
	if(this.flag_on_life){
		...
		this.tween_move1_dont_exist_off()
...
character.prototype.revive = function() {
	...
	//this.ghost_player.on=true
	this.tween_revive = game.add.tween(this).to({alpha:1},900,Phaser.Easing.Bounce.Out,true,200)
	this.tween_revive2 = game.add.tween(this).to({y:h2+25},900,Phaser.Easing.Bounce.Out,true,200)
...
character.prototype.tween_move1_dont_exist_on = function() {
	this.tween_move1_dont_exist=true	
}

character.prototype.tween_move1_dont_exist_off = function() {
	this.tween_move1_dont_exist=false	
}
...
var preloadstate = {
	preload: function(){ 
		...
		this.game.load.image("flash_blue","assets/flash_blue.png");
		//font bitmapFont
